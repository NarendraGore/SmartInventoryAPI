...
namespace SmartInventoryAPI.Migrations
{
    ...
    [Migration("20260402125526_foreign key added productid")]
    partial class foreignkeyaddedproductid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartInventoryAPI.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartInventoryAPI.Models.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartInventoryAPI.Models.Product", b =>
                {
                    ...
                    b.HasOne("SmartInventoryAPI.Models.Supplier", "Supplier")
                        .WithMany("Products")
